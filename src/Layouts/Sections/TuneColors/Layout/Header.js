    ...
    <header className='bg-black'>
      <nav aria-label="Global" className="mx-auto flex max-w-[1500px] items-center justify-between py-6 px-2 md:px-5 lg:px-0">
        <div className="flex lg:flex-1">
          <a
            href="/"
            aria-label="TuneColors"
            class="inline-flex items-center"
          >
            <img src={TuneColorsLogo} alt="Logo" className="lg:w-40 w-20" />
          </a>
        </div>
      ...
      <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
        ...
        <DialogPanel className="fixed inset-y-0 right-0 z-[100] w-full overflow-y-auto bg-black px-2 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <a
              ...
              class="inline-flex items-center"
            >
              <img src={TuneColorsLogo} alt="Logo" className="w-20" />
            </a>
            <button
              type="button"
            ...
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                ...
                <Disclosure as="div" className="-mx-3">
                  <DisclosureButton className="group flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-baxl font-bold leading-7 text-white hover:bg-gray-50">
                    Divisions
