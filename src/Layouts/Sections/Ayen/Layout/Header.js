    ...
    <header className='bg-black'>
      <nav aria-label="Global" className="mx-auto flex max-w-[1500px] items-center justify-between py-6 px-2 md:px-5 lg:px-0">
        <div className="flex lg:flex-1">
          ...
          >
            A<span className='text-blue-500'>YE</span>N
          </a>
        </div>
      ...
      <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
        ...
        <DialogPanel className="fixed inset-y-0 right-0 z-[100] w-full overflow-y-auto bg-marianaBlue px-2 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
