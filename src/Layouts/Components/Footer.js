...
export default function Footer() {
  return (
    <main>
      <section className="bg-marianaBlue py-40">
        <div
         className="max-w-lg bg-marianaBlue px-4 pt-14 mx-auto text-left md:max-w-none md:text-center"
        >
          <h1
          ...
          >
            ...
            >By Supporting <span className="bg-clip-text text-transparent bg-gradient-to-r from-deepYellow via-gray to-deepBlue"> our vision </span> </span>
          </h1>
          <div
      ...
      <footer className="bg-marianaBlue pb-5">
        <div className="max-w-[1500px] px-4 pt-8 mx-auto sm:px-6 lg:px-0">
          <div className="sm:flex sm:items-center sm:justify-between">
            <div className="flex justify-center text-teal-300 sm:justify-start">
              <img className="rounded-full" src={Logo} width="150" height="60" />
            </div>
